...
{\bf to put here: }some math background and including an example of some basic functionality (with output, but not to take a lot of space!)...
...
\section{Manipulating conditional independence statements}

\section{Computing the vanishing ideal}
...
\section*{Acknowledgements} -- other authors of the package!.... -- Dan Grayson and Amelia Taylor.
