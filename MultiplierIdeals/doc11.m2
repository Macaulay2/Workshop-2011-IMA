...
document {
  ...
  Headline => "make the ideal of a monomial curve",
	...
	Outputs => {"I" => Ideal => {}},
     ...
     PARA{},
     "With the optional argument", TT "Affine=>true", "the function produces
     instead the defining ideal of the affine curve given parametrically by
     t |---> (t^a1, ..., t^an). The default value, ", TT "Affine=>false",
     ", produces the ideal of the projective curve as above."
     EXAMPLE {
       "R = ZZ/101[x,y,z]",
       "monomialCurveIdeal(R,{4,5,11},Affine=>true)",
     }
     }
