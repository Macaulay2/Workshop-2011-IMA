...
factorTower2 Ideal := opts -> I -> (
   factorTower2(I_*,opts) / factorListToIdeal
)
...
-- Testing factorIrredZeroDimensionalTower
  ...
  m3 = g_2^2+(9/8)*g_4^2+(2*e_4^2+9*g_1^2)/8
  testList = {m1^2,m2,m3}
  factorTower(testList,"SplitIrred"=>true,"Minprimes"=>true)
  testList2 = {m1,m2,m3}
  time factorTower(testList2,"SplitIrred"=>true,"Minprimes"=>true)
  time factorTower2(testList2)
