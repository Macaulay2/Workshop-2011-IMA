...
\end{tikzpicture}
\caption{The duality between Betti tables and cohomology tables involves three cones.  Namely, given the Betti table $\beta(\FF)$ of a complex of free $S$-modules, and the cohomology table $\gamma(\cE)$ of a complex of coherent sheaves on $\PP^n$, we use our pairing to produce the Betti table $\beta(\Phi(\FF,\cE))$ of a complex free $A$-modules. Here, $\BBQ^{n+1}(S)$ and $\BBQ^{1}(A)$ denote, respectively, the cones of Betti tables of free complexes with homology of  finite length (codimension at least $n+1$ over $S$, or at least $1$ over $A$); and $\CC^{0}(\P^{n})$ denotes the cone of cohomology tables of coherent sheaves on $\P^{n}$. 
...
To decompose the Betti table of $F$ we consider the
complex 
is
\[
\bG := 
