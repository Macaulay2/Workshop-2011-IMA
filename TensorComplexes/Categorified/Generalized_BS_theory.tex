...
This new tool enables us to describe the cone of Betti tables of finite, minimal free complexes  having homology modules of specified dimensions over a polynomial ring, and we treat many examples beyond polynomial rings.  By constructing an analogue of our pairing between derived categories on a toric variety, we also obtain toric/multigraded analogues of the Eisenbud--Schreyer functionals.
