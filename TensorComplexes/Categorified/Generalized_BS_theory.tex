...
a single pairing between derived categories.
 ...
 Eisenbud and Schreyer developed the their theory to prove the \BS conjectures~\cite{boij-sod1},
which describe, up to scalar multiple, the possible values of Betti tables of finite free resolutions over a polynomial ring.  
...
Using our categorification we further extend the reach of the theory to complexes with homology and to many rings other than polynomial rings, where the only previous progress was that of~\cite{bbeg}. We also present a framework for an extension to the multigraded case of toric varieties, where the only previous progress was that of~\cites{boij-floystad,floystad-multigraded}.
