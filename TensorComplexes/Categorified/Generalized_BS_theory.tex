...
The theory, now known as \BS theory, was subsequently extended in to cover all free resolutions over a polynomial ring~\cite{boij-sod2,eis-schrey2},
a few special cases for resolutions over other rings~\cite{bbeg,beks-local} and for multigraded rings~\cite{boij-floystad,floystad-multigraded}, and more~\cite{beks-tensor,erman-semigroup,ees-filtering,sam-weyman}. All these extensions rely on the foundations established by Eisenbud and Schreyer. 
