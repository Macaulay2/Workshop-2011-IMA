...
\begin{abstract} 
%We present a more robust foundation for the duality theory introduced by Eisenbud and Schreyer to prove the \BS conjectures, which describe the numerical invariants coming from syzygies.
...
simultaneously categorifies all the functionals used by Eisenbud and Schreyer in their proof of the \BS conjectures.
Over the polynomial ring, this new tool enables us to describe the cone of Betti tables of finite, minimal free complexes with homology modules of specified dimensions.  We further use the pairing to describe cones of Betti tables and cohomology tables in many examples beyond $\PP^n$.  By constructing an analogue of our pairing between derived categories on a toric variety, we also obtain toric/multigraded analogues of the Eisenbud--Schreyer functionals.
