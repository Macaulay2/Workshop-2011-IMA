...
\end{thm}
For free resolutions, the theorem is due to~\cite{eis-schrey1}, where it follows from the proof of the main results.  Our contribution is to use the functor $\Phi$ to reinterpret their proof as a duality statement that involves three cones.  %See \S\ref{sec:duality} for more discussion of this duality.
...
%The functor $\Phi$ induces all the pairings defined by Eisenbud and Schreyer: 
