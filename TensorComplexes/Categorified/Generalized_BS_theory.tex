...
Our categorification of the duality gives a new foundation for Boij--S\"oderberg theory that allows us to substantially extend the reach of the theory.  
 In particular improve the  further extend the reach of the theory to complexes with homology and to many rings other than polynomial rings, where the only previous progress was that of~\cite{bbeg}. We also present a framework for an extension to the multigraded case of toric varieties, where the only previous progress was that of~\cites{boij-floystad,floystad-multigraded}.
