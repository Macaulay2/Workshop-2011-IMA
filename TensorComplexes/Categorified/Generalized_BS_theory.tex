...
%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%
In order to prove our Main Decomposition Theorem (Theorem ~\ref{thm:extremal rays refined}), we first consider cones on $A$, which is the target of $\Phi$.  
This will provide a base case for our main result.
% about cones of the form $\BBQ^{\bb}(S)$

\daniel{rewrite intro:  add exposition about ES-functionals and $\BBQ^1(A)$ functionals, and use that to lead into the general statement.}
